...
SCREEN_HEIGHT = 10 * SCALE
TITLE = "BMO's Adventure"
FPS = 30
...
yeet = load_font("assets/fonts/Cheri.ttf", 48)
FONT_XL = pygame.font.Font("assets/fonts/adv_time.ttf", 96)
FONT_md = pygame.font.Font("assets/fonts/adv_time.ttf", 48)

# Sounds
jump_snd = load_sound('assets/sounds/jump.ogg')
gem_snd = load_sound('assets/sounds/gem.ogg')
main_snd = load_sound('assets/sounds/title.ogg')
drooc = load_sound('assets/sounds/droocula.ogg')
winner = load_sound('assets/sounds/winner.ogg')
oof = load_sound('assets/sounds/oof.ogg')
loss = load_sound('assets/sounds/loss.ogg')
cleared = load_sound('assets/sounds/cleared.ogg')

# Images
idle = load_image('assets/images/characters/hero.png')
walk1 = load_image('assets/images/characters/hero_walk1.png')
walk2 = load_image('assets/images/characters/hero_walk2.png')
jump = load_image('assets/images/characters/hero_jump.png')
hurt = load_image('assets/images/characters/hero_hurt.png')
winnie = load_image('assets/images/characters/hero_win.png')
...
tile_images = { "Bricks": load_image('assets/images/tiles/bricks.png'),
                "Platform": load_image('assets/images/tiles/top_brick.png'),
                "Plant": load_image('assets/images/tiles/Plant.png'),
                "FlagTop": load_image('assets/images/tiles/medievalTile_166.png'),
                "FlagPole": load_image('assets/images/tiles/medievalTile_190.png'),
                "closed_door": load_image('assets/images/tiles/door.png'),
                "open_door": load_image('assets/images/tiles/open_door.png'),
                "rocket": load_image('assets/images/tiles/rocket.png'),
                "Grass": load_image('assets/images/tiles/grass_tile.png'),
                "Moon": load_image('assets/images/tiles/moon_tile.png'),
                "Grass_platform": load_image('assets/images/tiles/grass_platform.png'),
                "Grass_right": load_image('assets/images/tiles/grass_platform_right.png'),
                "Grass_left": load_image('assets/images/tiles/grass_platform_left.png'),
                "Moon_platform": load_image('assets/images/tiles/moon_platform.png').convert_alpha(),
                "Moon_left": load_image('assets/images/tiles/moon_platform_left.png'),
                "Moon_right": load_image('assets/images/tiles/moon_platform_right.png'),
                "Moon_rock": load_image('assets/images/tiles/moon_rock.png')}


        
basic_enemy_images = { "walk1": load_image('assets/images/characters/evan.png') }

platform_enemy_images = { "walk1": load_image('assets/images/characters/evan.png') } 

item_images = { "Gem": load_image('assets/images/items/celtic_red.png') }

start = load_image('assets/images/background/title_screen.png')
start = pygame.transform.scale(start, (SCREEN_WIDTH, SCREEN_HEIGHT))
fortnite = load_image('assets/images/background/fortnite.jpg')
fortnite = pygame.transform.scale(fortnite, (SCREEN_WIDTH, SCREEN_HEIGHT))
apex = load_image('assets/images/background/apex.jpg')
apex = pygame.transform.scale(apex, (SCREEN_WIDTH, SCREEN_HEIGHT))
full = load_image('assets/images/characters/heart_full.png')
empty = load_image('assets/images/characters/heart_empty.png')
...
class Hero(pygame.sprite.Sprite):
    ...
    def step(self):
        ...
        if self.step == 0:
            self.walk_index = (self.walk_index + 1) % len(self.images['walk1_rt', 'walk2_rt'])
...
class PlatformEnemy(BasicEnemy):
    ...
    def dead(self):
        global score
        hit_list = pygame.sprite.spritecollide(self, hero, True,
...
class Game():
    ...
    def show_title_screen(self):
        ...
        text = FONT_XL.render("TIME TO DO YOUR TAXES", 1, RED)
        screen.blit(text, [128, 204])
        
    def show_cleared_screen(self):
        text = font_lg.render("Level cleared", 1, RED)
        rect = text.get_rect()
    ...
    def show_pause():
        text = FONT_XL.render("You have paused", 1, RED)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
    ...
    def show_lose_screen(self):
        ...
        text = font_lg.render("You Commit Tax Fraud", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_stats(self):
        ...
        text = font_md.render(level_str, 1, RED)
        rect = text.get_rect()
        rect.left = 24
        rect.top = 24
        screen.blit(text, rect)
        ...
        text = font_md.render(score_str, 1, RED)
        rect = text.get_rect()
    ...
    def render(self):
        ...
        if self.stage == Game.START:
            ...
            loss.stop()
            cleared.stop()
            if self.hero.hearts == 3:
                screen.blit(full, (64, 64))
                screen.blit(full, (64 + 42, 64))
                screen.blit(full, (64 + 84, 64))
            elif self.hero.hearts == 2:
                screen.blit(empty, (64 + 84, 64))
                screen.blit(full, (64 + 42, 64))
                screen.blit(full, (64, 64))
            elif self.hero.hearts == 1:
                screen.blit(empty, (64 + 84, 64))
                screen.blit(empty, (64 + 42, 64))
                screen.blit(full, (64, 64))
        elif self.stage == Game.PAUSED:
            show_pause()
        elif self.stage == Game.CLEARED:
